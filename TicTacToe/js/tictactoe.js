...
function placeXOrO(squareNumber) {
    ...
    if(!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/catdinner.jpg")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        }
        else {
            //If activePlayer is equal to 'O', the o.png is placed in HTML
            select.style.backgroundImage = 'url("images/notacat.jpg")';
        }
        ...
        if (activePlayer === 'X') {
            //If active player is 'X' chane it to 'O'.
            activePlayer = 'O';
        ...
        audio('media/51702__bristolstories__ping.mp3');
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //This condition allows for our while loop to keep trying if a square is selected already.
        while (!success) {
...
function checkWinConditions() {
    ...
    //9 squares are selected the code executes.
        ...
        audio('media/618900__zj-davis__catmeow-small.wav');
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line indicates where the start of a line's y axis is.
        ...
        y = y1;
    //This function interacts with our canvas.
    function animateLineDrawing() {
        ...
        c.beginPath();
        //Thsi method moves us to a starting point in our line.
        c.moveTo(x1, y1);
    ...
    audio('media/439148__javapimp__lexie-yahoo.ogg');
